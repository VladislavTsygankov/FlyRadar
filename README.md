...
- [Fly Radar](#fly-radar)
    ...
    - [Требования](#значимые-функционалные-и-не-функциональные-требования)
    - [Ограничения](#технические-и-не-технические-ограничения)
    - [Решения и последствия](#решения-и-последствия)
    - [Конфигурация](#доставка-конфигурации-в-приложение)
    - [Декомпозиция](#декомпозиция)
        - [Логическая схема](#логическая-схема)
        - [Схема сервисов](#схема-сервисов)
    - [Тип архитектуры](#тип-архитектуры)
    - [Очередь](#очередь)
...
- Accesabilty - это для слепых (я даже как-то это делал)
